# CanEvolve <img align="right" width="208" height="129" src="icon.svg"><img align="right" width="208" height="129" src="https://github.com/tomouellette/CanEvolve.jl/blob/master/icon.svg?sanitize=true">
